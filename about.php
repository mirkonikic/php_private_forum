...
<div class="container-fluid">
    ...
    <h2 class="h1-responsive font-weight-bold text-center my-4">Welcome to the CN Forum!</h2>
    <p class="text-center w-responsive mx-auto mb-5">On CN Forum you are free to create a post/thread on any topic. The CN Chief Officers will respond in no time!</p>
